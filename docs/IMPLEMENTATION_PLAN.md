...
| M5 | in_progress | Egress、session、Transport、预算、取消、授权租约、延迟密钥与统一清理 | W08、W09-A 与 W09-B0 已推送；W09-B1 已在工作区完成并通过离线复核；B2–B4 DNS/peer/exact HTTP/TLS/全资源 cleanup 尚未实现 |
